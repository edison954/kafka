...
en: D:\_Install\kafka_2.12-2.5.0
./bin/windows/kafka-topics.bat


start zookeper en cmd
zookeeper-server-start.bat config\zookeeper.properties

en otro cmd  (cd D:\_Install\kafka_2.12-2.5.0)
...
Summary: 
    ...
    9 - Start Zookeeper in one command line: zookeeper-server-start.bat config\zookeeper.properties
    10- Start Kafka in another command line: kafka-server-start.bat config\server.properties
